...
- **Route to the right layer:** One-off -> docs note. Recurring fix -> skill or lint rule. Systemic issue -> principle
- **Close the loop:** Don't only record — apply now or create a concrete todo

**Anti-Patterns:**
- Acknowledging without recording ("I'll keep that in mind" does not persist)
- Recording without routing (docs note about a lint rule that should exist is wasted unless the lint rule gets implemented)
